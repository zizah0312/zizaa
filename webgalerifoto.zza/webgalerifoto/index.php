...
<title>WEB Galeri Foto Aziza</title>
...
<body>
    ...
    <header>
        <div class="container">
        <h1><a href="index.php">WEB GALERI FOTO Aziza</a></h1>
        <ul>
            ...
            <div class="box">
				...
				?>
                    <a href="galeri.php?kat=<?php echo $k['category_id'] ?>">
                        <div class="col-5">
                            <img src="img/zzah.png" width="50px" style="margin-bottom:5px;" />
    ...
    <!-- footer -->
     <footer>
        <div class="container">
            <small>Copyright &copy; 2024 - Web Galeri Foto Aziza.</small>
        </div>
    </footer>
</body>
</html>